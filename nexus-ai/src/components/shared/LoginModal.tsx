...
export default function LoginModal() {
  const { loginModalOpen, closeLoginModal, handleLogin } = useAppStore();
      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.body}>
          ...
          <div className={styles.subline}>
            {tab === 'login'
              ? 'Sign in to access your personalised AI hub'
              : 'Join thousands discovering the perfect AI model'}
          </div>

          {/* Tabs */}
          <div className={styles.tabs}>
            <button className={`${styles.tabBtn} ${tab === 'login' ? styles.active : ''}`} onClick={() => setTab('login')}>Sign In</button>
            <button className={`${styles.tabBtn} ${tab === 'signup' ? styles.active : ''}`} onClick={() => setTab('signup')}>Create Account</button>
          </div>
